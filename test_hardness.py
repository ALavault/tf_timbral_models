...
from timbral_models import timbral_hardness, tf_timbral_hardness
...
acm_score = np.array(timbral_hardness(fname, dev_output=False))
grad = True
acm_score2 = np.array(timbral_hardness(fname2, dev_output=False))
tt = 128*128
